                ...
                <tr class="hover:bg-gray-50/50 transition" x-data="{ tolakOpen: false, level: '' }">
                    ...
                    <td class="px-4 py-3">
                        <div class="flex items-center gap-1.5 flex-wrap">
                            {{-- Tombol ACC & Tolak Atasan --}}
                            @if($p->bisaApproveAtasan())
                            <form method="POST" action="{{ route('cuti.approve.atasan', $p) }}">
                                @csrf
                                <button type="submit"
                            ...
                            {{-- Tombol ACC & Tolak HRD --}}
                            @if($p->bisaApproveHrd())
                            <form method="POST" action="{{ route('cuti.approve.hrd', $p) }}">
                                @csrf
                                <button type="submit"
